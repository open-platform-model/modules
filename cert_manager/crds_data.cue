...
#cert_manager_io_certificaterequests: {
	...
	spec: {
		...
		versions: [{
			...
			selectableFields: [{jsonPath: ".spec.issuerRef.group"}, {jsonPath: ".spec.issuerRef.kind"}, {jsonPath: ".spec.issuerRef.name"}]
			served:  true
			storage: true
			subresources: status: {}
		}]
...
#acme_cert_manager_io_challenges: {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
...
#cert_manager_io_clusterissuers: {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
