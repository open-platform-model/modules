// schema.cue defines the CUE schema for Wolf's config.toml structure.
//
// This is a verbatim copy of modules/wolf/config_schema.cue with the package
// renamed to wolfinit, plus the additional runtime types (#PairedClientSettings,
// #PairedClientConfig, #WolfFullConfig) appended at the end.
package init
