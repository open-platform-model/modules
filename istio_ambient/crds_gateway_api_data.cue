...
#crdsGatewayAPI: "backendtlspolicies.gateway.networking.k8s.io": {
...
#crdsGatewayAPI: "gatewayclasses.gateway.networking.k8s.io": {
	//
...
#crdsGatewayAPI: "gateways.gateway.networking.k8s.io": {
	//
...
#crdsGatewayAPI: "grpcroutes.gateway.networking.k8s.io": {
	//
...
#crdsGatewayAPI: "httproutes.gateway.networking.k8s.io": {
	//
...
#crdsGatewayAPI: "referencegrants.gateway.networking.k8s.io": {
	//
