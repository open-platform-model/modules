...
_gwapiCRDs: "backendtlspolicies.gateway.networking.k8s.io": {
...
_gwapiCRDs: "gatewayclasses.gateway.networking.k8s.io": {
	//
...
_gwapiCRDs: "gateways.gateway.networking.k8s.io": {
	//
...
_gwapiCRDs: "grpcroutes.gateway.networking.k8s.io": {
	//
...
_gwapiCRDs: "httproutes.gateway.networking.k8s.io": {
	//
...
_gwapiCRDs: "listenersets.gateway.networking.k8s.io": {
	//
...
_gwapiCRDs: "referencegrants.gateway.networking.k8s.io": {
	//
...
_gwapiCRDs: "tlsroutes.gateway.networking.k8s.io": {
	//
